...
int http_conn::m_user_cont = 0;

const char* doc_root = "/data1/users/yonghui/websever/resources";
//用来向epoll中添加文件描述符
...
//修改文件描述符 重置oneshot事件，确保下一次可读时，可以被触发
...
void http_conn::init(){
    ...
    m_check_state = CHECK_STATE_REQUESTLINE;  //初始化当前状态为解析首行
    m_checked_idx = 0;
    m_start_line = 0;
    m_read_idx = 0;
    m_method = GET;
...
http_conn::HTTP_CODE http_conn::parse_request_line(char *text) {
    ...
    *m_version++ = '\0';
    ...
    m_check_state = CHECK_STATE_HEADER;   //将主状态机状态变为检查请求头
    return NO_REQUEST;
}
...
bool http_conn::read(){
    ...
    while(true){
        ...
        m_read_idx = m_read_idx + byte_read;
